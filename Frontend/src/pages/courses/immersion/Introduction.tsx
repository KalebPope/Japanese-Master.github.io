...
export default function Introduction() {
  return (
    ...
    <div className="flex flex-col max-w-7xl items-center mx-auto mt-30 font-medium font-intervariable">
      ...
      <img src="/JapaneseMaster/images/courses/Lessons/Introduction/Natsumatsuri.jpg" className="w-150 h-150"></img>
...
<div className="pt-10 text-md">  
   <img src="/JapaneseMaster/images/courses/Lessons/Introduction/Japan.jpg" className="w-100 h-100 self-start float-left mr-4"></img>
