    ...
    <>
      ...
      <div
        ...
        <div className="h-screen about-section relative -translate-x-20 opacity-0 transition-all duration-700 ease-out flex justify-center items-center">
          ...
          <img src="/JapaneseMaster/icons/down-arrow-red.png" className="w-10 h-15 mt-5 ml-10 animate-bounce" />
          </div>
          ...
          <img
            src={`/JapaneseMaster/images/home/${props.brushColour}`}
          ...
          <div className="grid grid-cols-[2fr_1fr_2fr] justify-center items-center">
            ...
            {/*Middle image*/}
            <img
              src={`/JapaneseMaster/images/home/${props.middleImage}`}
              className={`${
