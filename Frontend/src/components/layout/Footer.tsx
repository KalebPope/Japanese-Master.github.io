    ...
    <>
      <div className="w-7xl mx-auto h-100 flex flex-col justify-between items-center py-10">
        ...
        <div className="z-10 flex gap-20">
          <img src="/JapaneseMaster/icons/twitter.png" className="w-10 h-10" />
          <img src="/JapaneseMaster/icons/youtube.png" className="w-10 h-10" />
          <img src="/JapaneseMaster/icons/instagram.png" className="w-10 h-10" />
          <img src="/JapaneseMaster/icons/facebook.png" className="w-10 h-10" />
        </div>
      </div>
    </>
  );
